...
export async function generateMetadata() {
  ...
  let totalOpensource = 0

  let dbAvailable = true

  try {

    ;[totalTools, totalOpensource] = await Promise.all([
    ...
    console.warn(generateMetadata (home): database unavailable during build)
  ...
  if (dbAvailable) {
    ...
    return {
      ...
      title: `2Pix - 全球AI工具聚合平台 | 发现${totalTools}+实用AI工具`,

      description: `2Pix收录${totalTools}+个AI工具（含${totalOpensource}+开源），涵盖聊天对话、图像生成、视频生成、代码助手等16个分类。每日更新最新AI资讯和开源项目，一站式发现全球AI工具。`,

      openGraph: {

        title: `2Pix - 全球AI工具聚合平台 | ${totalTools}+AI工具`,
  ...
  return {
    ...
    title: 2Pix - 全球AI工具聚合平台 | 发现实用AI工具,

    description: 2Pix收录实用AI工具，涵盖聊天对话、图像生成、视频生成、代码助手等16个分类。每日更新最新AI资讯和开源项目，一站式发现全球AI工具。,
