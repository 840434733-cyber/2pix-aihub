...
export const metadata = {
  title: 'RSS 订阅 | 2Pix',
  description: '订阅 2Pix 的 RSS 资讯源，第一时间获取最新AI工具收录、行业资讯更新，涵盖大语言模型、AI绘画、代码助手、视频生成等领域动态。',
}
...
export default async function RssPage() {
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.2pix.cn'
      ...
      <section className="relative pt-28 pb-16 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-cyber-muted-foreground font-mono leading-relaxed max-w-xl mx-auto">
            订阅 2Pix，第一时间收到最新 AI 工具上线通知和 AI 资讯更新。
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              { step: '04', title: '享受更新', desc: '每当 2Pix 有新工具上线或资讯发布，阅读器会自动推送通知。', color: 'text-neon-yellow' },
