...
export const metadata: Metadata = {
  title: '2Pix - 全球AI工具聚合平台',
  description: '2Pix收录海量AI工具、开源项目和最新AI资讯，涵盖聊天对话、图像生成、视频生成、代码助手等分类。每日更新，一站式发现全球AI工具。',
  keywords: 'AI工具, AI导航, 人工智能工具, AI工具导航站, 免费AI工具, AI集合, AI汇总, 2pix',
  icons: {
    icon: [
  ...
  openGraph: {
    title: '2Pix - 全球AI工具聚合平台',
    description: '2Pix收录1000+AI工具与最新AI资讯，涵盖聊天对话、图像生成、视频生成、代码助手等16个分类，每日更新，一站式发现全球AI工具。',
    type: 'website',
    locale: 'zh_CN',
  },
  robots: {
  ...
  other: {
    ...
    'msthumbnail': 'https://www.2pix.cn/favicon-32x32.png',
